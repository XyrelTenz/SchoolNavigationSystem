...
export default function Index({ navigation }: LoginFormProps) {
    ...
    <View style={{ flex: 1, backgroundColor: "white", padding: 16 }}>
      ...
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={{ fontSize: 22, fontWeight: "bold", color: "#600EE6", textAlign: "center", marginTop: 16 }}>
          {current.title}
        </Text>
        <Text style={{ fontSize: 14, color: "#414757", textAlign: "center", marginTop: 8, marginBottom: 24 }}>
          {current.description}
        </Text>
      ...
      {!current.isAuthStep && (
        <View style={{ position: "absolute", bottom: 40, width: width, alignItems: "center" }}>
          ...
          {/* Back and Next icons */}
          <View style={{ position: "absolute", bottom: 0, width: width, flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 20 }}>
            {step > 0 ? (
